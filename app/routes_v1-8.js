...
var folder = "v1-8/_find-adviser/filters"
...
router.post('/_get-funding/questions/gf-eligibility-previous-application', function (req, res) {
    ...
    if (fundingApplication === "yes") {
        res.redirect('/v1-8/_get-funding/questions/gf-eligibility-application-reference');
    } else {
        res.redirect('/v1-8/_get-funding/gf-results');
    };
})
...
router.post('/_get-funding/questions/gf-eligibility-what-for', function (req, res) {
    ...
    if (fundingType === "yes") {
        res.redirect('/v1-8/_get-funding/questions/gf-eligibility-application-successful');
    } else {
        res.redirect('/v1-8/_get-funding/questions/gf-eligibility-application-successful');
    };
})
...
router.post('/_get-funding/questions/gf-eligibility-application-successful', function (req, res) {
    ...
    if (applicationStatus === "yes") {
        res.redirect('/v1-8/_get-funding/questions/gf-eligibility-funding-received');
    } else {
        res.redirect('/v1-8/_get-funding/questions/gf-eligibility-why-unsuccessful');
    };
})
